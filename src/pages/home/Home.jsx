    ...
    return (
        <div data-aos="fade-up">
            <div className="homeComponent" >
                <img className="homePageImg" src={hpage} />
                <div className="buttonFlex">
                      <div className="homeHook">
                        <span className="mySpan">
                            Where <span className={`span2 ${classActive ? "strickThrough" : ""}`}></span> <span className="span2"> FLavors </span>Meet Perfection.
                        </span>
                        <br></br>
                        <span className={`mySpan2 ${classActive2 ? "cursorAnimation" : ""}`}>
                              Discover the art of pure vegetarian dining — only at Satvik Restaurant.
                        </span>
                    </div>
